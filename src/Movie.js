...
const Movie = () => {
  ...
  useEffect(() => {
    axios
      .get("https://productapi56.azurewebsites.net/api/Movie/GetAllMovies")
      .then((response) => {
  ...
  const getMovieById = (event) => {
    axios
      .get(
        "https://productapi56.azurewebsites.net/api/Movie/GetMovieById/" + id
      )
      .then((response) => {
        //(response.data);
        console.log(response.data);
  ...
  const addMovie = (event) => {
    ...
    axios
      .post("https://productapi56.azurewebsites.net/api/Movie/AddMovie/", movie)
      .then((response) => {
        console.log(response.data);
      })
      .catch((error) => {
  ...
  const deletMobieById = (event) => {
    axios
      .delete(
        "https://productapi56.azurewebsites.net/api/Movie/DeleteMovie/" + id
      )
      .then((response) => {
        console.log(response.data);
      })
  ...
  const editMovie = (event) => {
    ...
    console.log(movie);
    axios
      .put("https://productapi56.azurewebsites.net/api/Movie/EditMovie/", movie)
      .then((response) => {
        console.log(response.data);
      })
      .catch((error) => {
